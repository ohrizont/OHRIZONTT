...
with pd.ExcelWriter(
    ...
    imp_df.to_excel(writer, sheet_name="importancias_gb", index=False)
    lift_df.to_excel(writer, sheet_name="lift_gb", index=False)

print("✔ Gradient Boosting entrenado y guardado en Excel")
print(f"AUC GB: {auc:.4f}")
